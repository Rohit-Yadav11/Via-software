 ...
 */
class Adri_Ajdethemes_Customize_Alpha_Color_Control extends WP_Customize_Control {
	...
	public function enqueue() {
		wp_enqueue_script(
			'alpha-color-picker',
			get_stylesheet_directory_uri() . '/assets/js/vendors/alpha-color-picker.js',
		...
		wp_enqueue_style(
			'alpha-color-picker',
			get_stylesheet_directory_uri() . '/assets/css/vendors/alpha-color-picker.css',
