...
class Reading_Progress extends Module_Base
{
    ...
    public function get_style_depends() {
        if ($this->ep_is_edit_mode()) {
           ...
           return [ 'bdt-uikit-icons', 'ep-reading-progress' ];
        }
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .bdt-progress-with-cursor .bdt-progress-wrap, {{WRAPPER}}  .bdt-progress-with-top .bdt-progress-wrap .svg-content ',
                'condition' => [
                    '_skin' => [ 'bdt-back-to-top-with-progress', 'bdt-progress-with-cursor' ],
                ],
            ]
