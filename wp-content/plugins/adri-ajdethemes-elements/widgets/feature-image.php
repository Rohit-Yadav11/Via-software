 ...
 * @since 1.0.0
 */
class Ajdethemes_Widget_Feature_Image extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Feature Image', 'adri-ajdethemes-elements' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Feature Image', 'adri-ajdethemes-elements' ),
			]
		);
