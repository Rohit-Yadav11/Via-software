<div id="lock-options"  class="tab-pane">
    ...
    <div class="wpdm-accordion w3eden">
        ...
        <div class="panel panel-default">
            <h3 class="panel-heading"><label><input type="checkbox" class="wpdmlock wpdm-checkbox"  rel='terms' name="file[terms_lock]" <?php if(get_post_meta($post->ID,'__wpdm_terms_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Must Agree with Terms" , "download-manager" ); ?></label></h3>
        ...
        <div class="panel panel-default">
        <h3 class="panel-heading"><label><input type="checkbox" class="wpdmlock wpdm-checkbox"  rel='password' name="file[password_lock]" <?php if(get_post_meta($post->ID,'__wpdm_password_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Enable Password Lock" , "download-manager" ); ?></label></h3>
        ...
        <div class="panel panel-default">
            <h3 class="panel-heading"><label><input type="checkbox" rel="linkedin" class="wpdmlock wpdm-checkbox"  name="file[linkedin_lock]" <?php if(get_post_meta($post->ID,'__wpdm_linkedin_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "LinkedIn Share Lock" , "download-manager" ); ?></label></h3>
        ...
        <div class="panel panel-default">
            <h3 class="panel-heading"><label><input type="checkbox" rel="tweeter" class="wpdmlock wpdm-checkbox"  name="file[tweet_lock]" <?php if(get_post_meta($post->ID,'__wpdm_tweet_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Tweet Lock" , "download-manager" ); ?></label></h3>
        ...
        <div class="panel panel-default">
            <h3 class="panel-heading"><label><input type="checkbox" rel="gplusone" class="wpdmlock wpdm-checkbox"  name="file[gplusone_lock]" <?php if(get_post_meta($post->ID,'__wpdm_gplusone_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Enable Google +1 Lock" , "download-manager" ); ?></label></h3>
        ...
        <div class="panel panel-default">
            <h3 class="panel-heading"><label><input type="checkbox" rel="gplusshare" class="wpdmlock wpdm-checkbox"  name="file[twitterfollow_lock]" <?php if(get_post_meta($post->ID,'__wpdm_twitterfollow_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Enable Twitter Follow Lock" , "download-manager" ); ?></label></h3>
        ...
        <div class="panel panel-default">
            <h3 class="panel-heading"><label><input type="checkbox" rel="facebooklike" class="wpdmlock wpdm-checkbox"  name="file[facebooklike_lock]" <?php if(get_post_meta($post->ID,'__wpdm_facebooklike_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Enable Facebook Like Lock" , "download-manager" ); ?></label></h3>
        ...
        <div class="panel panel-default">
            <h3 class="panel-heading"><label><input type="checkbox" rel="email" class="wpdmlock wpdm-checkbox"  name="file[email_lock]" <?php if(get_post_meta($post->ID,'__wpdm_email_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Enable Email Lock" , "download-manager" ); ?></label></h3>
        ...
        <!-- Captcha Lock -->
        <div class="panel panel-default">
            <h3 class="panel-heading"><label><input type="checkbox" rel="captcha" class="wpdmlock wpdm-checkbox"  name="file[captcha_lock]" <?php if(get_post_meta($post->ID,'__wpdm_captcha_lock', true)=='1') echo "checked=checked"; ?> value="1"><?php echo __( "Enable Captcha Lock" , "download-manager" ); ?></label></h3>
...
<script>
    jQuery(function ($) {
        $('.wpdmlock').addClass('wpdm-checkbox');
    });
</script>
<style>
    input.wpdm-radio[type="radio"], input.wpdm-checkbox[type="checkbox"]{ background: #ffffff; }
</style>