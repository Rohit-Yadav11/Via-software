                    ...
                    foreach ($files as $id => $value): ++$file_index;
                        ...
                        <div class="cfile">
                            <div class="panel panel-default panel-file">
                                ...
                                <div class="panel-heading"><button type="button" class="btn btn-xs btn-danger float-right" rel="del"><i class="fas fa-trash"></i></button> <span title="<?php echo $value; ?>"><?php echo strlen($value)<100?$value:substr($value, 0, 80).'...'; ?></span></div>
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="media">
