                ...
                <div class="col-md-12">
                    ...
                    if(is_array($__wpdm_social_login) && count($__wpdm_social_login) > 1) { ?>
                        <div class="text-center panel panel-default" style="margin: 20px 0 0 0">
                            <div class="panel-heading"  data-toggle="collapse" href="#socialllogin" role="button" aria-expanded="false" aria-controls="socialllogin"><?php _e("Or connect using your social account", "download-manager") ?></div>
