...
<div class="tab-pane hide" id="file_info_<?= $id ?>">
    <div class="form-group">
        <div class="media">
            <div class="pull-left">
                <img class="file-ico"
                     onerror="this.src='<?php echo \WPDM\libs\FileSystem::fileTypeIcon($ext); ?>';"
            ...
            <div class="media-body">
                <input placeholder="<?php _e("File Title", "download-manager"); ?>"
                       ...
                       value="<?php echo !isset($fileinfo[$id]['title']) ? wpdm_valueof($fileinfo, "{$value}/title", ["validate" => "esc_html"]) : wpdm_valueof($fileinfo, "{$id}/title", ["validate" => "esc_html"]); ?>"/><br/>
                <div class="row">
                    <div class="col-lg-6">
                    ...
                    <div class="col-lg-6">
                        <div class="input-group">
                            <input placeholder="<?php _e("File Password", "download-manager"); ?>"
                                   ...
                                   value="<?php echo wpdm_valueof($fileinfo, "{$id}/password"); ?>">
                            <span class="input-group-btn">
                ...
                <div class="row" style="margin-top: 10px">
                    <div class="col-lg-6">
                        ...
                        <input type="text" class="form-control" placeholder="1.0.0" name="file[fileinfo][<?php echo $id; ?>][version]" value="<?php echo wpdm_valueof($fileinfo, "{$id}/version"); ?>" />
                    </div>
                    <div class="col-lg-6">
                        <label><?php echo __( 'Update Date', 'download-manager' ); ?>:</label>
                        <input type="date" style="padding: 0 15px" class="form-control" name="file[fileinfo][<?php echo $id; ?>][update_date]" value="<?php echo wpdm_valueof($fileinfo, "{$id}/update_date"); ?>" />
                    </div>
        ...
        <div class="form-group">
            <div class="file-access-settings"
                ...
                <table class="table table-v table-bordered file-price-data file-price-table" <?php if ($license_req != 1) echo "style='display:none;'"; ?>>
                    ...
                    <tr>
                        <td colspan="<?= count($pre_licenses); ?>"><?php _e('License specific file price:', 'download-manager'); ?></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="<?= count($pre_licenses); ?>"><?php _e('File availability with license pack:', 'download-manager'); ?></td>
                    </tr>
                    <tr>
                        <?php
                ...
                <div class="input-group file-price-data file-price-field" <?php if ($license_req == 1) echo "style='display:none;'"; ?>>
                    ...
                    <input class="form-control" type="text" name="file[fileinfo][<?php echo $id; ?>][price]" value="<?php echo !isset($fileinfo[$id]['price']) ? '' : (double)$fileinfo[$id]['price']; ?>" />
                </div>
