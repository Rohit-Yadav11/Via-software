                ...
                <div class="panel-footer card-footer">
                    <div class="row">
                        <div class="col-lg-<?php echo $sr; ?> col-md-12">
                            <input type="text" name="skw" value="<?php echo stripslashes_deep(wpdm_query_var('skw', 'txt')) ?>" placeholder="<?php echo __( "Search Keyword...", "download-manager" ); ?>" class="form-control form-control-sm" />
                        </div>
                        ...
                        <div class="col-lg-<?php echo $bt; ?> col-md-4">
                            <button type="submit" class="btn btn-secondary btn-sm btn-block"><?php echo __( "Apply Filter", "download-manager" ) ?></button>
                        </div>
                    </div>
