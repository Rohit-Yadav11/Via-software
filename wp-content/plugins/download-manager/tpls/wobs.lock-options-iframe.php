    ...
    <div class="modal-dialog modal-dialog-centered" role="document" style="width: <?php echo $terms_lock === 1?395:365; ?>px;max-width: calc(100% - 20px);">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                echo WPDM()->package::downloadLink(wpdm_query_var('__wpdmlo'), 1);
                ?>
            </div>
...
<script>
    ...
    jQuery(function ($) {
        ...
        $('body').on('click', 'div.modal-backdrop,.modal .close', function () {
            hideModal();
        });
    ...
    function showModal() {
        jQuery('body').addClass('modal-open').append("<div class='modal-backdrop fade show'></div>");
        jQuery('#wpdm-locks').css('display', 'block').addClass('show');
    }
    function hideModal() {
        jQuery('body').removeClass('modal-open');
        jQuery('div.modal-backdrop').remove();
        jQuery('#wpdm-locks').removeClass('show').css('display', 'none');
