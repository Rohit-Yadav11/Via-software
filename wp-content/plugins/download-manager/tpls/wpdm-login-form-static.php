    ...
    <div id="wpdmlogin" <?php if(wpdm_query_var('action') == 'lostpassword') echo 'class="lostpass"'; ?>>
        ...
        <form name="loginform" id="loginform" action="" method="post" class="login-form" >
            ...
            <div id="__signin_msg"><?php
                $wpdm_signup_success = Session::get('wpdm_signup_success');
                if(trim($wpdm_signup_success) !== ''){
                    Session::clear('wpdm_signup_success');
                    ?>
            ...
            <div class="form-group">
                <input placeholder="<?php _e( "Username or Email" , "download-manager" ); ?>" type="text" name="wpdm_login[log]" id="user_login" class="form-control form-control-lg required text" value="" size="20" tabindex="38" />
            </div>
            <div class="form-group">
                <input type="password" placeholder="<?php _e( "Password" , "download-manager" ); ?>" name="wpdm_login[pwd]" id="user_pass" class="form-control form-control-lg required password" value="" size="20" tabindex="39" />
            </div>
                ...
                <div class="col-md-12">
                    ...
                    if(is_array($__wpdm_social_login) && count($__wpdm_social_login) > 1) { ?>
                        <div class="text-center card card-default" style="margin: 20px 0 0 0">
                            <div class="card-header"><?php _e("Or connect using your social account", "download-manager") ?></div>
                            <div class="card-body">
