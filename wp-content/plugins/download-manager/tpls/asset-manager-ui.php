        ...
        <div class="panel-body">
            <div class="media well-sm well-file" style="margin: 0;padding: 0">
                ...
                <h3 style="display: inline-block;font-size: 12pt;letter-spacing: 0.5px;font-weight: 400;font-family: var(--wpdm-font)">
                   <img src="<?php echo WPDM_BASE_URL ?>assets/images/asset-manager.svg" style="height: 20px" /> <?php echo __( "Digital Asset Manager", "download-manager" ) ?> <sup style="color: var(--color-info) !important;font-size: 10px;font-family: 'Overpass Mono', sans-serif !important;">BETA</sup>
                </h3>
                                    ...
                                    <div class="modal-dialog modal-sm" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div id="upload" class="modal-body">
                                                <input type="text" v-bind:value="asset.name" placeholder="New Name" id="newname" class="form-control form-control-lg" style="margin: 0px;border: 1px dashed #d4d4d4;">
                                            </div>
